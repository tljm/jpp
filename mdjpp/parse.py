...
# Date tag:
# 
# Each Date tag has begin and end time. First Time tag in given Date tag is
# begin and last Time tag is end. If there is only one Time tag then it is end.
# Within given Date tag we can have current Time.
#
# Multi tag:
# 
# 
